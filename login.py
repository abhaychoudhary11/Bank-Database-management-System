...
password= Entry(frame,width=65,show='*',fg='white',border=2,bg="white",font=('Poppins',11))
password.place(x=30,y=220)

#button
Button(frame,width=20,pady=7,text='Login',bg='#57a1f8',fg='white',border=0).place(x=210,y=280)
